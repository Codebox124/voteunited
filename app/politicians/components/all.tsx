  ...
  >
    ...
    <div className={`p-6 ${isTopRanked ? "flex flex-col justify-center" : ""}`}>
      <div className="space-y-4">
        ...
        <button className=" cursor-pointer w-full mt-4 px-6 py-3 bg-primary dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-slate-200 text-white dark:text-slate-900 rounded-none font-semibold  transition-all duration-200 flex items-center justify-center gap-2 group">
          View Profile
        </button>
      </div>
    </div>
